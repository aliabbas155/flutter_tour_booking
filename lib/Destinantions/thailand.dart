...
class Thailand_placeone extends StatelessWidget {
  const Thailand_placeone({super.key});
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Image.asset(
            'assets/images/Thailandspot.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ...
          Align(
            ...
            child: Container(
              height: 200,
              width: 350,
              color: const Color.fromARGB(255, 151, 18, 3).withOpacity(0.5),
              child: Center(
                child: Column(
