...
class Greece_placeone extends StatelessWidget {
  const Greece_placeone({super.key});
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Image.asset(
            'assets/images/Greecespot.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ...
          Align(
            ...
            child: Container(
              height: 200,
              width: 350,
              color: const Color.fromARGB(255, 54, 1, 1).withOpacity(0.5),
              child: Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    const Text(
                      "Welcome to Greece, Sir",
                      style: TextStyle(
                        fontSize: 24,
