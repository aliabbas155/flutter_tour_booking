...
class Spain_placeone extends StatelessWidget {
  const Spain_placeone({super.key});
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Image.asset(
            'assets/images/Spainspot.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ...
          Align(
            ...
            child: Container(
              height: 200,
              width: 350,
              color: const Color.fromARGB(255, 204, 33, 238).withOpacity(0.5),
              child: Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    const Text(
                      "Welcome to Spain, Sir",
                      style: TextStyle(
                        fontSize: 24,
                    ...
                    const Text(
                      "Adventure Awaits! 🌍 Book Your Ticket to Explore the World and Create Memories That Last a Lifetime. 🌟✈️",
                      style: TextStyle(
                        fontSize: 16,
                        color: Colors.white,
                      ),
