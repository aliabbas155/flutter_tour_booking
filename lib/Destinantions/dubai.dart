...
class Dubai_placeone extends StatelessWidget {
  const Dubai_placeone({super.key});
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Image.asset(
            'assets/images/dubaiSpot.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ...
          Align(
            ...
            child: Container(
              height: 200,
              width: 350,
              color: const Color.fromARGB(255, 228, 214, 15).withOpacity(0.5),
              child: Center(
                child: Column(
