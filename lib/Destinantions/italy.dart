...
class Italy_placeone extends StatelessWidget {
  const Italy_placeone({super.key});
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Image.asset(
            'assets/images/Italyspot.jpg', // Replace with your image path
            fit: BoxFit.cover,
          ...
          Align(
            ...
            child: Container(
              height: 200,
              width: 350,
              color: const Color.fromARGB(255, 62, 192, 2).withOpacity(0.5),
              child: Center(
                child: Column(
